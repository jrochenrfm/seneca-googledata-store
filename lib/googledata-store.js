...
function isSaved(entity){
  ...
  /**
    ...
    load: function(args,cb) {
      var kind = createCollectionName(args.ent);
      var query = createLoadQuery(kind, args.q);
